---
name: soul-generator
description: Generates tailored SOUL.md documents for agents based on their job duties
  and personality requirements. Use when creating new agents to quickly generate appropriate
  SOUL.md files that match the agent's role and vibe.
version: 1.0.0
author: openclaw
license: MIT
---
