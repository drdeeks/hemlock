---
name: agent-mail
description: Use AgentMail to programmatically create accounts on third-party services.
  Handles inbox creation, signup forms, email verification via AgentMail API, and
  credential extraction. Use when signing up for any service that requires email verification
  (Pinata, GitHub, cloud providers, etc.).
version: 1.0.0
metadata:
  hermes:
    tags:
